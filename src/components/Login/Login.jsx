...
import LogoGym from '../../images/LogoGym.png'; // Ajusta la ruta según la ubicación de tu archivo
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 px-6">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <img className="mx-auto h-10 w-auto" src={LogoGym} alt="Logo Gym" />
        <h2 className="mt-6 text-center text-3xl leading-9 font-extrabold text-gray-900">
          Sign in to your account
        </h2>
        <p className="mt-2 text-center text-sm leading-5 text-blue-500 max-w">
          Or
          <a href="/register" className="font-medium text-blue-500 hover:text-blue-500 focus:outline-none focus:underline transition ease-in-out duration-150">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="text-sm leading-5">
                <a href="/forgot-password" className="font-medium text-blue-500 hover:text-blue-500 focus:outline-none focus:underline transition ease-in-out duration-150">
